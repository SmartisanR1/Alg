...
func (a *App) SM2GenerateRawKey() gm.SM2KeyResult {
...
func (a *App) SM3HashWithID(req gm.SM3WithIDRequest) symmetric.CryptoResult {
...
func (a *App) SM9GenerateEncMasterKey() gm.SM9MasterKeyResult {
	return gm.SM9GenerateEncMasterKey()
}

func (a *App) SM9GenerateEncKey(masterPriv string, uid string) gm.SM9KeyResult {
...
func (a *App) XWingKeyGen() pqc.PQCKeyResult {
	return pqc.XWingKeyGen()
}

func (a *App) XWingEncapsulate(req pqc.XWingRequest) pqc.PQCEncapResult {
