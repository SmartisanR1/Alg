      ...
      <div class="sym-side">
        ...
        <Card title="算法原理">
          <div class="space-y-2 text-[12px] leading-5" :class="isDark ? 'text-dark-muted' : 'text-light-muted'">
            ...
            <div class="card">
              <p class="card-title text-amber-400">SM4-CMAC</p>
      ...
      <div class="sym-side">
        ...
        <Card title="算法原理">
          <div class="space-y-2 text-[12px] leading-5" :class="isDark ? 'text-dark-muted' : 'text-light-muted'">
            ...
            <div class="card">
              <p class="card-title text-amber-400">使用提醒</p>
      ...
      <div class="sym-side">
        ...
        <div class="card">
          ...
          <div class="space-y-2 text-[12px] leading-5" :class="isDark ? 'text-dark-muted' : 'text-light-muted'">
            ...
            <div class="card">
              <p class="card-title text-amber-400">SM4 UDK</p>
      ...
      <div class="sym-side">
        ...
        <div class="card">
          ...
          <div class="space-y-2 text-[12px] leading-5" :class="isDark ? 'text-dark-muted' : 'text-light-muted'">
            ...
            <div class="card">
              <p class="card-title text-amber-400">3DES / SM4</p>
