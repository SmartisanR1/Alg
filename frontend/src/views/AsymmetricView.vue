        ...
        <Card title="RSA 密钥生成">
          ...
          <div v-if="rsaKeys.privateKey" class="space-y-3 animate-in fade-in duration-300">
            ...
            <div>
              ...
              <div class="result-area !min-h-0 text-cyan-300 !text-[10px] break-all max-h-24 overflow-y-auto font-mono">
        ...
        <Card v-if="sm2Sub === 'keygen'" title="SM2 密钥对生成">
          ...
          <div v-if="sm2Keys.privateKey" class="space-y-4 flex-1 overflow-y-auto pr-1 custom-scrollbar">
            ...
            <div>
              ...
              <div class="result-area !min-h-[60px] text-cyan-300 !text-[11px] break-all max-h-32 overflow-y-auto font-mono border-cyan-500/10 bg-cyan-500/5">
          ...
          <div class="space-y-2">
            ...
            <div v-if="sm9Master.publicKey" class="card !bg-transparent space-y-2 animate-in fade-in duration-300">
              ...
              <div>
                ...
                <div class="result-area ck-key-hex !min-h-0 text-cyan-300 text-[10px] break-all max-h-20 overflow-y-auto font-mono">{{ sm9Master.publicKey }}</div>
              </div>
            </div>
            <div v-if="sm9EncMaster.publicKey" class="card !bg-transparent space-y-2 animate-in fade-in duration-300">
              ...
              <div>
                ...
                <div class="result-area ck-key-hex !min-h-0 text-cyan-300 text-[10px] break-all max-h-20 overflow-y-auto font-mono">{{ sm9EncMaster.publicKey }}</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <Card title="Curve25519 系列操作">
          ...
          <div v-if="c25519.privateKey" class="space-y-2 animate-in fade-in duration-300">
            ...
            <div>
              ...
              <div class="result-area !min-h-0 text-cyan-300 text-[10px] font-mono break-all">{{ c25519.publicKey }}</div>
            </div>
          </div>
        </Card>
        <Card>
