        ...
        <Card title="RSA 密钥生成">
          ...
          <div v-if="rsaKeys.privateKey" class="space-y-3 animate-in fade-in duration-300">
            <div>
              ...
              <div class="result-area !min-h-0 text-amber-200 !text-[12px] break-all max-h-40 overflow-y-auto font-mono">
        ...
        <Card v-if="sm2Sub === 'keygen'" title="SM2 密钥对生成">
          ...
          <div v-if="sm2Keys.privateKey" class="space-y-4 flex-1 overflow-y-auto pr-1 custom-scrollbar">
            <div>
              ...
              <div class="result-area !min-h-[80px] text-amber-200 !text-[12px] break-all max-h-40 overflow-y-auto font-mono border-amber-400/20 bg-amber-400/10">
          ...
          <div class="space-y-2">
            ...
            <div v-if="sm9Master.publicKey" class="card !bg-transparent space-y-2 animate-in fade-in duration-300">
              <div>
                ...
                <div class="result-area ck-key-hex !min-h-0 text-amber-200 text-[12px] break-all max-h-32 overflow-y-auto font-mono">{{ sm9Master.privateKey }}</div>
              </div>
              <div>
            ...
            <div v-if="sm9EncMaster.publicKey" class="card !bg-transparent space-y-2 animate-in fade-in duration-300">
              <div>
                ...
                <div class="result-area ck-key-hex !min-h-0 text-amber-200 text-[12px] break-all max-h-32 overflow-y-auto font-mono">{{ sm9EncMaster.privateKey }}</div>
              </div>
              <div>
        ...
        <Card title="Curve25519 系列操作">
          ...
          <div v-if="c25519.privateKey" class="space-y-2 animate-in fade-in duration-300">
            <div>
              ...
              <div class="result-area !min-h-0 text-amber-200 text-[12px] font-mono break-all">{{ c25519.privateKey }}</div>
            </div>
            <div>
